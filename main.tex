...
\begin{document}
  {\Huge\bfseries\scshape Linear Bandits}\vspace{1em}\par
  Matthew Nazari, \hspace{0.5em} Moni Radev\par
  \texttt{%
  \{%
  \href{mailto:matthewnazari@college.harvard.edu}{matthewnazari},%
  \href{mailto:sradev@college.harvard.edu}{sradev}%
  \}%
  @college.harvard.edu}\vspace{1em}\par
  {CS 282br}\par
  {Presentation Notes}\par
  {8 October 2021}\par
  
  \section{Setup and Motivation} % Motivations from Chapter 7 and Chapter 5 stuff

  \section{Hedge Algorithm} % Talking about Hedge algorithm and weighted majority 

  \section{Reduction } % Chapter 6 content
